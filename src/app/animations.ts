import { animate, animation, AnimationAnimateRefMetadata, AnimationReferenceMetadata, AnimationTriggerMetadata,
  ...
  export const slideFadeIn = animation(
    ...
    { params: { time: '700ms', startPos: '100%' } },
  );
   ...
   */
  export function useSlideFadeInAnimation(time: string = '700ms', startPos: string = '100%'): AnimationReferenceMetadata {
   ...
   */
  export function useSlideFadeOutAnimation(time: string = '700ms', endPos: string = '100%'): AnimationReferenceMetadata {
   ...
   * @param time the duration of the animation
   */
  export function useGrowInAnimation(time: string = '700ms'): AnimationReferenceMetadata {
   ...
   * @param time the duration of the animation
   */
  export function useShrinkOutAnimation(time: string = '700ms'): AnimationReferenceMetadata {
  ...
  export const swingIn = animation(
    [
      ...
      group([
        useAnimation(grow, {params: {time: '700ms'}}),
        animate('{{time}}',
        keyframes([
  ...
  export const swingOut = animation(
    ...
    useAnimation(shrink, {params: {time: '700ms'}}),
  ],
  {params: {time: '300ms'}},
  );
  /**
   ...
   * @param time the duration of the animation
   */
  export function useBounceInUpAnimation(time: string = '700ms'): AnimationReferenceMetadata {
   ...
   * @param time The duration of the animation
   */
  export function useBounceOutDownAnimation(time: string = '700ms'): AnimationReferenceMetadata {
