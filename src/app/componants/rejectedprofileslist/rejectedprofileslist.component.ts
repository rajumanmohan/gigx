...
@Component({
  selector: 'app-rejectedprofileslist',
  templateUrl: './rejectedprofileslist.component.html',
  styleUrls: ['./rejectedprofileslist.component.scss'],
...
export class RejectedProfilesListComponent implements OnInit {
  postId;
  talentProfilesList = [];
  paginationIndex = 0;
  itemsPerPage = 5;
  ...
  getRejectedTalentProfilesByPostId(){
    this.appSer.getRejectedTalentProfilesByPostId(this.postId).subscribe((res) => {
